<?php
// HTTP
define('HTTP_SERVER', 'http://192.168.0.10/admin/');
define('HTTP_CATALOG', 'http://192.168.0.10/');

// HTTPS
define('HTTPS_SERVER', 'http://192.168.0.10/admin/');
define('HTTPS_CATALOG', 'http://192.168.0.10/');
